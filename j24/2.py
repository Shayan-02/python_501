...
class Database:
    ...
    def __init__(
        self, db
    ):  # pass self to avoid TypeError: '...takes 0 positional arguments but 1 was given.'
        """
        ...
        self.cur.execute(
            "CREATE TABLE IF NOT EXISTS book (id INTEGER PRIMARY KEY AUTO_INCREMENT, title text, author text, year integer, isbn integer)"
        )
        self.conn.commit()
